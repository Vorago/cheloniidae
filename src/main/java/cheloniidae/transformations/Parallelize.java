...
import cheloniidae.NonDistributiveProxy;
...
public class Parallelize implements Transformation<TurtleCommand> {
    ...
    public Parallelize() {
        commandBeingWrapped = null;
    }

    private Parallelize(final TurtleCommand _commandBeingWrapped) {
        commandBeingWrapped = _commandBeingWrapped;
    }
