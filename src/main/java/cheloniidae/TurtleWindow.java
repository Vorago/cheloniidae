...
public class TurtleWindow<T extends Turtle> extends Frame implements Viewport {
    ...
    public int drawingRefreshInterval() {
        return drawingRefreshInterval;
    }

    public TurtleWindow drawingRefreshInterval(final int _drawingRefreshInterval) {
        drawingRefreshInterval = _drawingRefreshInterval;
        return this;
    }

    public boolean shouldShowObjectCount() {
        return shouldShowObjectCount;
    }

    public TurtleWindow shouldShowObjectCount(final boolean _shouldShowObjectCount) {
        shouldShowObjectCount = _shouldShowObjectCount;
        return this;
    }

    public int intermediatePointCloudSize() {
        return intermediatePointCloud.length;
    }

    public TurtleWindow intermediatePointCloudSize(final int _intermediatePointCloudSize) {
        intermediatePointCloud = new Vector[_intermediatePointCloudSize];
        return this;
    }
    ...
    public TurtleWindow add(final T t) {
        turtles.turtles().add(t);
        t.window(this);
        return this;
    }
    ...
    public TurtleWindow representativePoint(final Vector v) {
        ...
        if (intermediatePointCloud[index] == null || new Random().nextDouble() > 0.97)
            intermediatePointCloud[index] = v;
    ...
    public class RenderOperation extends Thread {
        ...
        public RenderOperation(final Viewport v) {
            viewport = v;
        }
